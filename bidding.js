            ...
            if (response.channels[encodeURIComponent(new_msg_bidding_channel)] && encodeURIComponent(new_msg_bidding_channel) in response.channels) {
                response.channels[encodeURIComponent(new_msg_bidding_channel)].forEach((message) => {
                    ...
                    if (parseInt(new_bid) > parseInt(last_bid)) {
                        ...
                        actionCompleted({action: 'Place A Bid', windowLocation: orglocation}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
...
function newItem() {
    ...
    actionCompleted({action: 'Create An Auction', windowLocation: orglocation}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
...
function loadBidding(channel) {
    ...
    if (channel == "your-bids") {
        ...
        setActive("auctions");
        actionCompleted({action: 'View Your Auctions', windowLocation: orglocation}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
        ...
        setActive(channel);
        actionCompleted({action: 'Change Category', windowLocation: orglocation}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
...
const updateUI = async () => {
    ...
    if (!isAuthenticated) {
        ...
        actionCompleted({action: 'Login To Bid', windowLocation: orglocation}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
