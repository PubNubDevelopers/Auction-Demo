            ...
            if (response.channels[encodeURIComponent(new_msg_bidding_channel)] && encodeURIComponent(new_msg_bidding_channel) in response.channels) {
                response.channels[encodeURIComponent(new_msg_bidding_channel)].forEach((message) => {
                    ...
                    if (parseInt(new_bid) > parseInt(last_bid)) {
                        ...
                        actionCompleted({action: 'Place A Bid'}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
...
function newItem() {
    ...
    actionCompleted({action: 'Create An Auction'}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
...
function loadBidding(channel) {
    ...
    if (channel == "your-bids") {
        ...
        setActive("auctions");
        actionCompleted({action: 'View Your Auctions'}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
        ...
        setActive(channel);
        actionCompleted({action: 'Change Category'}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
    ...
    pubnub.fetchMessages( // Get the last 10 items
        ...
        function (status, response) {
            ...
            if (document.getElementById('items-area').childNodes.length === 0) {
                document.getElementById('items-area').innerHTML = "<h2>Nothing here to show. Try creating a new auction or placing a bid.</h2>"
            } 
        }
    );
}
...
const updateUI = async () => {
    ...
    if (!isAuthenticated) {
        ...
        actionCompleted({action: 'Login To Bid'}); // This is for the interactive demo on PubNub.com. It is not part of the demo of this application. 
